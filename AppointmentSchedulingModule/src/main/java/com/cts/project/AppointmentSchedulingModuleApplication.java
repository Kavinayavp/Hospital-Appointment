...
/**
 * Main class for the Appointment Scheduling Module.
 * This application handles appointment management and integrates with external services via Feign Clients.
 */
