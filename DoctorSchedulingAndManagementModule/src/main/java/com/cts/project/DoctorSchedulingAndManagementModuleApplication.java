...
/**
 * Main class for the Doctor Scheduling and Management Module. This application
 * enables doctor scheduling features and integrates with external services via
 * Feign Clients.
 */
