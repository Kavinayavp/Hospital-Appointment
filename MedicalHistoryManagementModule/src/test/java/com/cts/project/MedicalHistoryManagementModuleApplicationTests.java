...
class MedicalHistoryServiceImplTest {
	...
	void setUp() {
		...
		history = MedicalHistory.builder().historyId(1L).patientId(1001L).illness("Flu").treatment("Rest and fluids")
				.doctorName("Dr. Sarah Johnson").visitDate("2025-05-01").prescription("Paracetamol").build();

		dto = MedicalHistoryDTO.builder().historyId(1L).patientId(1001L).illness("Flu").treatment("Rest and fluids")
				.doctorName("Dr. Sarah Johnson").visitDate("2025-05-01").prescription("Paracetamol").build();
	}
